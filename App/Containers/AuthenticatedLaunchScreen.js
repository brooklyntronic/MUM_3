...
class AuthenticatedLaunchScreen extends Component {
  ...
  render () {
    ...
    return (
      ...
      {this.props.complete ? <ButtonBox onPress={this.openProfile} style={styles.bottomLeftButton} text='My Profile' icon='user-circle' iconSize={40}/> : <Animatable.View animation="pulse" easing="ease-out" iterationCount={!this.props.complete ? "infinite" : 1}><ButtonBox onPress={this.openProfile} style={styles.bottomLeftButton} text='My Profile' icon='user-circle' iconSize={40}/></Animatable.View>}
      {this.props.complete ? <ButtonBox onPress={this.openPreferences} style={styles.bottomRightButton} text='Preferences' icon='wrench' iconSize={40} /> : <Animatable.View animation="pulse" easing="ease-out" iterationCount={!this.props.complete ? "infinite" : 1}><ButtonBox onPress={this.openPreferences} style={styles.bottomRightButton} text='Preferences' icon='wrench' iconSize={40} /></Animatable.View>}
      </View>
      </View>
      </ScrollView>
      )
